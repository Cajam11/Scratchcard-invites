...
A lightweight Next.js app that lets see their scratchcard-style invites. Teachers have to solve short puzzles (hidden words) to access their invite.
The app uses Supabase for authentication and persistence, Tailwind CSS for styling, and small scripts for QR generation and utilities.
