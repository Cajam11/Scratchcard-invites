      ...
      >
        ...
        <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-7xl flex-col items-center justify-center px-3 py-6 sm:px-8 lg:px-12">
          <div
            ref={invitationRef}
            data-export-root="invite"
            className="w-full overflow-hidden rounded-none border border-[rgba(46,95,168,0.58)] bg-[linear-gradient(120deg,#07101d_5%,#0c1b32_50%,#091624_100%)] p-0 shadow-[0_38px_110px_rgba(2,6,15,0.95)]"
          >
            <div className="grid min-h-[clamp(27rem,60vh,42rem)] grid-cols-1 divide-y divide-[rgba(46,95,168,0.16)] sm:grid-cols-2 sm:divide-y-0 lg:grid-cols-[0.92fr_1.16fr_0.92fr] lg:min-h-[clamp(27rem,56vh,44rem)] lg:divide-x lg:divide-[rgba(46,95,168,0.16)]">
              <section className="flex h-full flex-col bg-[linear-gradient(180deg,rgba(11,24,44,0.55)_0%,rgba(7,15,28,0.78)_100%)] px-4 py-4 sm:px-5 sm:py-5 lg:px-6 lg:py-6">
                ...
                <div className="grid flex-1 content-start grid-cols-2 gap-1 sm:gap-1.5 text-[10px] sm:text-xs text-[#d6e5fa]">
                  {classStudents.map((name) => (
                    <p
                      key={name}
                      className="border border-[rgba(46,95,168,0.26)] bg-[#0a1830] px-2 py-1 text-center leading-tight"
                    >
                      {name}
                    </p>
                  ))}
              ...
              <section className="flex h-full flex-col bg-[linear-gradient(180deg,rgba(11,24,44,0.55)_0%,rgba(7,15,28,0.78)_100%)] px-4 py-4 sm:px-5 sm:py-5 lg:px-6 lg:py-6 sm:col-span-2 lg:col-span-1">
                ...
                <p className="mt-3 sm:mt-5 text-xs sm:text-sm leading-5 sm:leading-7 text-[#d6e1f1] flex-1">
                  Srdecne Vas pozyvame na nasu stuzkovu. Tesime sa, ze budete
                  sucastou nasho vecera.
                </p>
          ...
          <div className="mt-4 sm:mt-6 text-center">
            <button
              ...
              className="inline-flex items-center justify-center rounded-full border border-[#3f7ad1] bg-[#2f64b3] px-4 sm:px-6 py-2 sm:py-3 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.18em] sm:tracking-[0.2em] text-[#e7f1ff] transition hover:bg-[#3a75cb] disabled:cursor-not-allowed disabled:opacity-60"
            >
